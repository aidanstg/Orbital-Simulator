...
public class SimPanel extends JPanel implements Runnable {
    ...
    SimPanel() {
        ...
        newParticle("geosynchronous satillite", metersPerPixel.multiply(new BigDecimal(GAME_WIDTH / 2.0)), metersPerPixel.multiply(new BigDecimal(GAME_HEIGHT / 2.0)).add(new BigDecimal(35786000 + 6378000.0)), new BigDecimal(3075.5555556 - 12.71358004020), new BigDecimal(0.0), new BigDecimal(1500), new BigDecimal(1), metersPerPixel);
